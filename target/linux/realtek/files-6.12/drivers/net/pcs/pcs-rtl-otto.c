...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_common_type1[] =
{
	{0x21, 0x00, 0x1800}, {0x21, 0x01, 0x0060}, {0x21, 0x02, 0x3000}, {0x21, 0x03, 0xFFFF},
	{0x21, 0x04, 0x0603}, {0x21, 0x05, 0x1104}, {0x21, 0x06, 0x4444}, {0x21, 0x07, 0x7044},
	{0x21, 0x08, 0xF104}, {0x21, 0x09, 0xF104}, {0x21, 0x0A, 0xF104}, {0x21, 0x0B, 0x0003},
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_5g_type1[] =
{
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_5g_cmu_type1[] =
{
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_3p125g_type1[] =
{
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_3p125g_cmu_type1[] =
{
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_2p5g_type1[] =
{
...
static const struct rtpcs_sds_config rtpcs_931x_sds_cfg_1p25g_type1[] =
{
...
static int rtpcs_931x_sds_patch(struct rtpcs_serdes *sds, int chiptype)
{
	//struct rtpcs_serdes *even_sds = rtpcs_sds_get_even(sds);
	int val;

	if (chiptype) {
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_common_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_10p3125g_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_10p3125g_cmu_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_5g_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_5g_cmu_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_3p125g_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_3p125g_cmu_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_2p5g_type1);
		rtpcs_sds_apply_seq(sds, rtpcs_931x_sds_cfg_1p25g_type1);
	} else {
	...
	val = 0xa0000;
	regmap_write(sds->ctrl->map, RTL93XX_CHIP_INFO, val);
	regmap_read(sds->ctrl->map, RTL93XX_CHIP_INFO, &val);
	if (val & BIT(28))
				   ...
				   phy_interface_t mode)
{
	...
	rtpcs_931x_sds_patch(sds, chiptype);
